...
p1 = heatmap(αList, qList, σiMat, ylimit=(-1.5,0), xlimit=(0,2), color=:tempo, color=:tempo, xlabel=L"n", ylabel=L"q", colorbar_title="Growth rate", clim=(0,0.6))

plot!(p1, xmirror = true, size=(600, 700))
